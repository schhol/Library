...
public class LibrarySystemJavaApplication {
	...
	public class DemoData implements ApplicationRunner {
		...
		public void run(ApplicationArguments args) throws Exception {
			...
			Book b4 = new Book("1112211111", 2011 ,"sdaa", "Picaswsqssso", 4.5, "VeryGood", 4, "Good book about art", ld2);
			Book b5 = new Book("1112211111", 2020 ,"asas", "Picaaasso", 4.5, "VeryGood", 4, "Good book about art", ld2);
			Book b6 = new Book("1112211111", 2016 ,"gsdsdsd", "Pissscasso", 4.5, "VeryGood", 4, "Good book about art", ld2);
